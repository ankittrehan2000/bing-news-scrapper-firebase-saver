...
//.then(
/* (async() => {
    div#main button[type="submit"].f7e-update-button.mat-raised-button.mat-button-base.mat-primary.ng-star-inserted.cdk-focused.cdk-mouse-focused > span
    //*[@id="main"]/ng-transclude/div/div/div/f7e-data/div/div/data/div/mat-card/div[2]/f7e-inline-editor/mat-card/mat-card-content/form/mat-card-actions/div/button[2]/div[1]
    #main > ng-transclude > div > div > div > f7e-data > div > div > data > div > mat-card > div:nth-child(3) > f7e-inline-editor > mat-card > mat-card-content > form > mat-card-actions > div > button.f7e-update-button.mat-raised-button.mat-button-base.mat-primary.ng-star-inserted > div.mat-button-ripple.mat-ripple
    ...
    await page.click('devsite-user > div > a');

    await page.waitForSelector('input#identifierId');

    await page.click('input#identifierId');

    await page.type('input#identifierId','testaccapp1234');

    await page.waitForSelector('div#identifierNext > div.ZFr60d.CeoRYc');

    await page.click('div#identifierNext > div.ZFr60d.CeoRYc');
    ...
    await page.type('input[name="password"]','actingpause');

    await page.click('div#initialView > div.xkfVF');

    await page.waitForSelector('div#passwordNext span > span');

    await page.click('div#passwordNext span > span');

    await page.waitForSelector('div.devsite-top-logo-row-wrapper-wrapper > div > div > a');

    await page.click('div.devsite-top-logo-row-wrapper-wrapper > div > div > a');

    await page.waitForSelector('div:nth-child(4) > project-card > mat-card > div.spacer');

    await page.click('div:nth-child(4) > project-card > mat-card > div.spacer');

    await page.waitForSelector('div#nav-develop-tree-content fb-navbar-item:nth-child(2) > a > div');

    await page.click('div#nav-develop-tree-content fb-navbar-item:nth-child(2) > a > div');

    await page.waitForSelector('div#main fs-animate-changes:nth-child(1) > f7e-data-tree > div > div > div.database-key-value');

    await page.hover('div#main fs-animate-changes:nth-child(1) > f7e-data-tree > div > div > div.database-key-value');

    await page.waitForSelector('div#main fs-animate-changes:nth-child(1) > f7e-data-tree > div > div > div.database-buttons > mat-icon.material-icons.mat-icon.notranslate.mat-icon-no-color.ng-star-inserted');

    await page.click('div#main fs-animate-changes:nth-child(1) > f7e-data-tree > div > div > div.database-buttons > mat-icon.material-icons.mat-icon.notranslate.mat-icon-no-color.ng-star-inserted');

    await page.waitForSelector('div#field_value > input');

    await page.click('div#field_value > input', { clickCount: 3 });

    await page.keyboard.press('Backspace');

    //await page.evaluate( () => document.getElementById("div#field_value > input").value = "");

    await page.type('div#field_value > input','news');

    //await page.waitForSelector('div#main mat-card-actions');

    await page.click('div#main mat-card-actions');

    await page.waitForSelector('div#main button[type="submit"].f7e-update-button.mat-raised-button.mat-button-base.mat-primary.ng-star-inserted > .mat-button-wrapper');

    await page.hover('div#main button[type="submit"].f7e-update-button.mat-raised-button.mat-button-base.mat-primary.ng-star-inserted > .mat-button-wrapper')

    await page.click('div#main button[type="submit"].f7e-update-button.mat-raised-button.mat-button-base.mat-primary.ng-star-inserted > .mat-button-wrapper');
    //await browser.close();
